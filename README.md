...
# Forex Currency Exchange Api Integration App
...
###
*[Swagger URL] http://localhost:8080/forex/swagger-ui.html
*[API URL] http://localhost:8080/forex/api/exchageRates?source=<currency_value>
* Example currency_value = USD
